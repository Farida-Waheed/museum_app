...
abstract class AppLocalizations {
  ...
  /// No description provided for @museumExperienceDesc.
  ///
  /// In en, this message translates to:
  /// **'Customize how Horus-Bot guides you through the museum.'**
  String get museumExperienceDesc;

  /// No description provided for @autoFollowRobot.
  ///
  /// In en, this message translates to:
  /// **'Follow Horus-Bot automatically'**
  String get autoFollowRobot;

  /// No description provided for @showNearbyExhibits.
  ///
  /// In en, this message translates to:
  /// **'Show nearby exhibits'**
  String get showNearbyExhibits;

  /// No description provided for @enableExhibitExplanations.
  ///
  /// In en, this message translates to:
  /// **'Enable exhibit explanations'**
  String get enableExhibitExplanations;

  /// No description provided for @enableVoiceInteraction.
  ///
  /// In en, this message translates to:
  /// **'Enable voice interaction'**
  String get enableVoiceInteraction;
  ...
  /// No description provided for @deniedForever.
  ///
  /// In en, this message translates to:
  /// **'Denied Forever'**
  ...
  /// No description provided for @audioGuideMode.
  ///
  /// In en, this message translates to:
  /// **'Audio Guide Mode'**
  String get audioGuideMode;

  /// No description provided for @audioGuideModeDesc.
  ///
  /// In en, this message translates to:
