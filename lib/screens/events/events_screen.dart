...
class EventsScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildEventCard(l10n.workshop, l10n.workshopDesc, Icons.edit_note),
            const SizedBox(height: 12),
            _buildEventCard(l10n.talk, l10n.talkDesc, Icons.record_voice_over),
          ],
        ),
      ),
    );
  ...
  Widget _buildEventCard(String title, String desc, IconData icon) {
    return AppCard(
      child: Row(
        children: [
