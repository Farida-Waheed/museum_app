...
class _SupportConversationScreenState extends State<SupportConversationScreen> {
  ...
  SupportRequest? get _request => widget.requestId == null ? null : _service.getRequest(widget.requestId!);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(l10n.supportConversationTitle),
                ...
                Expanded(
                  child: ListView(
                    ...
                    children: [
                      ...
                      ...request.messages.map((message) => _SupportChatBubble(
                            message: message,
                    ...
                    children: [
                      ...
                      CircleAvatar(
                        ...
                        child: IconButton(
                          ...
                          icon: const Icon(Icons.send_rounded, size: 20, color: AppColors.darkInk),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text('${l10n.supportRequestFrom}: ', style: AppTextStyles.metadata(context).copyWith(color: Colors.white70)),
              Text(request.screen, style: AppTextStyles.metadata(context).copyWith(color: Colors.white)),
            ],
          ),
          ...
          Text(
            ...
            style: AppTextStyles.bodyPrimary(context).copyWith(color: Colors.white70, height: 1.5),
          ),
        ],
      ),
    );
        ...
        children: [
          if (!isUser)
            CircleAvatar(
              ...
              child: const Icon(Icons.support_agent_outlined, size: 16, color: AppColors.primaryGold),
            ),
          ...
          Flexible(
            child: Container(
              ...
              child: Text(
                message.text,
                textDirection: dir,
                style: AppTextStyles.bodyPrimary(context).copyWith(color: textColor, height: 1.5),
              ),
            ),
          ),
          if (isUser) const SizedBox(width: 10),
          if (isUser)
            CircleAvatar(
              radius: 14,
              backgroundColor: AppColors.primaryGold.withOpacity(0.15),
              child: const Icon(Icons.person_outline, size: 16, color: AppColors.primaryGold),
            ),
        ],
      ),
    );
