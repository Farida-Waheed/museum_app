...
class AchievementsScreen extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
             Container(
               ...
               child: Row(
                 children: [
                   const Icon(Icons.stars, size: 48, color: AppColors.primaryGold),
             ...
             _buildAchievementTile(context, Icons.map, l10n.wayfinder, l10n.wayfinderDesc, false),
          ],
        ),
      ),
    );
  ...
  Widget _buildAchievementTile(BuildContext context, IconData icon, String title, String subtitle, bool isUnlocked) {
    return Container(
      margin: const EdgeInsets.only(bottom: 12),
      decoration: BoxDecoration(
        color: AppColors.cinematicCard,
        borderRadius: BorderRadius.circular(20),
        border: Border.all(color: isUnlocked ? AppColors.primaryGold.withOpacity(0.3) : Colors.white.withOpacity(0.03)),
      ),
      child: ListTile(
