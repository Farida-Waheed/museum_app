          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                ...
                BoxShadow(color: AppColors.bronzeGlow(0.04), blurRadius: 20),
              ],
            ),
            child: Stack(
              children: [
                const Positioned.fill(child: _LiveCardHighlight()),
                Row(
...
class _LiveCardHighlight extends StatelessWidget {
  const _LiveCardHighlight();
